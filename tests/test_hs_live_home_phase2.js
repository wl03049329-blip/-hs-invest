...
assert.match(html, /canonicalForHome=liveCanonicalCoreSnapshot\|\|latestCanonicalCoreSnapshot/);
assert.match(html, /if\(!canonicalForHome\)canonicalForHome=await loadCanonicalCoreLedger/);
