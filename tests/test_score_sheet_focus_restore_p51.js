...
const context={document,all:items,$:selector=>nodes[selector],strategyDecisionFor:()=>decision,esc:String,fmt:value=>String(value),requestAnimationFrame:fn=>fn(),coreScoreHistoryState:ticker=>ticker==="009815"?{kind:"wait_native",rows:[]}:{kind:"empty",rows:[]},console};
