(function(root,factory){
  ...
  function item(raw,key){
    ...
    return{
      ...
      quoteTime,sourceDate,sourceName:String(raw.source_name||"Yahoo Finance chart JSON"),sourceUrl:String(raw.source_url||""),
