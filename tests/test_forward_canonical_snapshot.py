...
charts={ticker:(chart(),{}) for ticker in p.UNIVERSE}; data,manifest=p.build(charts,"2026-08-10","2026-08-10T13:30:00+00:00"); data2,manifest2=p.build(charts,"2026-08-10","2026-08-10T13:30:00+00:00"); assert p.canonical(data)==p.canonical(data2) and p.canonical(manifest)==p.canonical(manifest2)
