...
function validate(directory,expectedDate){
  ...
  if(!manifest.producer_sha256||!manifest.producer_schema_version||!manifest.adjustment_algorithm_version||!manifest.repair_manifest_version||!manifest.repair_manifest)fail("PROVENANCE");
