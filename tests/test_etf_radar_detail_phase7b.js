...
(async()=>{
  ...
  assert.match(html,/data-radar-outcomes-phase="7b"/);assert.match(html,/function radarHistoricalResearchHtml[\s\S]*radarHistoryPhase6Html\(x\)[\s\S]*radarOutcomePhase7BHtml\(x\)/);assert.match(html,/20260919-radar-events-phase105/);
