...
assert.match(consumer, /const snapshotForRender=currentCanonicalCoreSnapshot\(taipeiToday\(\)\)/);
...
console.log("G PASS: homepage consumes the shared canonical resolver; proxy cannot publish radar Core");
