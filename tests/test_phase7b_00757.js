...
test("historical trigger mapping exact",()=>assert.deepEqual([30,40,45,50,65,70,80,90].map(score=>core.labelFor(score).triggerRate),[22.1,14.8,11.6,9.04,3.62,2.8,1.32,.27]));
