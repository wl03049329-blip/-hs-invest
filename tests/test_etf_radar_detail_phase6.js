...
(async()=>{
  ...
  assert.match(html,/formal-black-gold\.css\?v=20260919-radar-history-research-v1/);assert.match(html,/20260919-radar-history-research-v1/);
