...
const expected00830Score=Number(snapshot.items["00830"].score),expected00830Display=Math.floor(expected00830Score),expected00830Classification=core.labelFor(expected00830Score);
...
assert.strictEqual(current00830.coreScore,expected00830Score);
assert.strictEqual(current00830.coreScoreDisplay,expected00830Display);
assert.strictEqual(current00830.historicalTriggerRate,expected00830Classification.triggerRate);
assert.strictEqual(current00830.label,expected00830Classification.label);
