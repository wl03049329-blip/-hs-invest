...
(async()=>{
  ...
  assert.match(html,/data-radar-outcomes-phase="7b"/);assert.ok(html.indexOf("${radarHistoryPhase6Html(x)}${radarOutcomePhase7BHtml(x)}")>0);assert.match(html,/20260919-outcomes-phase7b/);
